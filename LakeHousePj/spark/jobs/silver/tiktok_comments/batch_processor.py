...
# ================================================================================
# DEAD CODE: ENTIRE FILE NOT USED
# Status: No module imports `batch_processor` (verified via grep).
# Functions defined here (NONE of them are called from anywhere):
#   - read_partitions_batch
#   - process_posts_batch
#   - process_comments_batch
#   - create_batches  (same name as file_processor.create_batches;
#                      the one actually used is in file_processor.py, NOT this one)
# Reason: Pipeline merged batch logic directly into
#         step_02_clean_load.py::process_batches(). This module is leftover
#         from an earlier refactor that was never finalized.
# Action: Safe to DELETE this entire file.
# ================================================================================
