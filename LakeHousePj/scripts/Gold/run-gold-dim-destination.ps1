# ============================================
# Run Gold Layer - dim_destination Job
# ============================================
# Purpose: Build destination dimension table
# Source : /data/VietNam_Province/List_Destination.csv
# Target : gold.dim_destination (Iceberg)
# ============================================

Write-Host ""
Write-Host "============================================" -ForegroundColor Cyan
Write-Host "   Gold Layer - dim_destination Job" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""

Write-Host "[*] Job Details:" -ForegroundColor Yellow
Write-Host "   Source: /data/VietNam_Province/List_Destination.csv" -ForegroundColor White
Write-Host "   Target: gold.dim_destination" -ForegroundColor White
...
docker exec lakehouse_spark_master /opt/spark/bin/spark-submit `
  ...
  --deploy-mode client `
  --conf spark.app.name="Gold_Dim_Destination" `
  ...
  --executor-cores 2 `
  --num-executors 1 `
  /opt/spark/jobs/gold/dim_destination/dim_destination_job.py
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "   1. Query: spark.table('gold.dim_destination').show()" -ForegroundColor Cyan
    ...
    Write-Host "   2. docker exec lakehouse_spark_master ls -la /data/VietNam_Province/" -ForegroundColor Cyan
